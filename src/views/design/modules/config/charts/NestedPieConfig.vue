        ...
        <ChartProprietaryTemplate>
          <template v-slot:header>
            <a-collapse :bordered="false" defaultActiveKey="1">
              <a-collapse-panel header="内玫瑰图" key="1">
                <div class="comment-template__item">
                  <p class="comment-template__leading">玫瑰图:</p>
                  <div class="comment-template__inner">
                    <a-select v-model="config.proprietaryConfig.roseType" @change="change">
              ...
              <a-collapse-panel header="外玫瑰图" key="2">
                <div class="comment-template__item">
                  <p class="comment-template__leading">玫瑰图:</p>
                  <div class="comment-template__inner">
                    <a-select v-model="config.proprietaryConfig.roseType2" @change="change">
                      <a-select-option value="none">无</a-select-option>
                      <a-select-option value="area">圆心角 - 半径</a-select-option>
                      <a-select-option value="radius">半径</a-select-option>
                    </a-select>
          ...
          <template>
            <a-collapse :bordered="false">
              ...
              <a-collapse-panel header="内半径" key="2">
                <div class="comment-template__item">
              ...
              <a-collapse-panel header="外半径" key="20">
                <div class="comment-template__item">
                  <p class="comment-template__leading">内半径:</p>
                  <div class="comment-template__inner">
                    <a-input
                      type="text"
                      @change="change"
                      v-model="config.proprietaryConfig.radius2.inside"
                    />
                  </div>
                </div>
                <!-- / 内半径 -->
                ...
                <div class="comment-template__item">
                  ...
                  <div class="comment-template__inner">
                    <a-input
                      type="text"
                      @change="change"
                      v-model="config.proprietaryConfig.radius2.outside"
                    />
                  </div>
                </div>
                <!-- / 外半径 -->
              ...
              <a-collapse-panel header="内标签" key="3" class="visible-collapse-panel">
                <div class="comment-template__item">
              ...
              <a-collapse-panel header="外标签" key="30" class="visible-collapse-panel">
                <div class="comment-template__item">
                  <p class="comment-template__leading">显示</p>
                  <div class="comment-template__inner comment-template__end">
                    <a-switch
                      checkedChildren="显示"
                      unCheckedChildren="隐藏"
                      v-model="config.proprietaryConfig.pieLabel2.show"
                      @change="change"
                    />
                  </div>
                </div>
                ...
                <div v-if="config.proprietaryConfig.pieLabel.show">
                  <div class="comment-template__item">
                    ...
                    <div class="comment-template__inner comment-template__end">
                      <a-radio-group
                        buttonStyle="solid"
                        v-model="config.proprietaryConfig.pieLabel2.position"
                        @change="change"
                      >
                        <a-radio-button value="outside">外侧</a-radio-button>
                        <a-radio-button value="inside">内部</a-radio-button>
                  ...
                  <div class="comment-template__item">
                    ...
                    <div class="comment-template__inner comment-template__end">
                      <a-radio-group
                        buttonStyle="solid"
                        v-model="config.proprietaryConfig.pieLabel2.fontStyle"
                        @change="change"
                      >
                        <a-radio-button value="normal">正常</a-radio-button>
                        <a-radio-button value="italic">斜体</a-radio-button>
                  ...
                  <div class="comment-template__item">
                    ...
                    <div class="comment-template__inner comment-template__end">
                      <a-radio-group
                        buttonStyle="solid"
                        v-model="config.proprietaryConfig.pieLabel2.fontWeight"
                        @change="change"
                      >
                        <a-radio-button value="normal">正常</a-radio-button>
                        <a-radio-button value="lighter">细</a-radio-button>
                  ...
                  <div class="comment-template__item">
                    ...
                    <div class="comment-template__inner">
                      <a-slider
                        ...
                        :max="32"
                        @change="change"
                        v-model="config.proprietaryConfig.pieLabel2.fontSize"
                      />
                    </div>
                  </div>
                  <!-- / 标签大小 -->
  ...
  methods: {
    ...
    getColors(config) {
      ...
      if (config.proprietaryConfig.pieItemStyle.colorType === "custom") {
        color = [
          ...this[customMapping.get(config.proprietaryConfig.pieItemStyle.type)]
        ];
      } else {
        const { colors } = this[
          typeMapping.get(config.proprietaryConfig.pieItemStyle.type)
        ].find(
          item =>
            item.type === config.proprietaryConfig.pieItemStyle.colorScheme
        );
        color = [...colors];
      }
      return color;
    ...
    combinationColorChange(config) {
      this.combinationCustomColors =
        config.proprietaryConfig.pieItemStyle.color;
      this.change();
    },
    /**
     * 渐变颜色选择
