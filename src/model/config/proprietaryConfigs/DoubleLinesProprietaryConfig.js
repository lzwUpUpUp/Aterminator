 ...
 */
export default class DoubleLinesProprietaryConfig {
  constructor ({
    smooth = true,
    showSymbol = true,
    symbol = 'emptyCircle',
    ...
    this.y1Axis = new YAixs(y1Axis)
    this.y2Axis = new YAixs(y2Axis)
  }
  ...
  getOption () {
    return Object.assign(_.cloneDeep(this), {
      ...
      y1Axis:this.y1Axis.getOption(),
      y2Axis:this.y2Axis.getOption()
    })
  }
}
